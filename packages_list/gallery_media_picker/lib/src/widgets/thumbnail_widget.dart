          ...
          builder: (_, data) {
            if (data.hasData) {
              return SizedBox(
                ...
                child: Image(
                  image: DecodeImage(provider.pathList[provider.pathList.indexOf(provider.currentPath!)], thumbSize: thumbnailQuality, index: index),
        ...
        if (asset.type == AssetType.video)
          Align(
            ...
            child: Padding(
              ...
              child: Container(
                  decoration: BoxDecoration(color: Colors.black.withOpacity(0.8), borderRadius: BorderRadius.circular(10), border: Border.all(color: Colors.white, width: 1)),
