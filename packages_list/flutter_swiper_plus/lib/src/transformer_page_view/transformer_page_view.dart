...
export 'package:flutter_swiper_plus/src/transformer_page_view/index_controller.dart';
export 'package:flutter_swiper_plus/src/transformer_page_view/parallax.dart';
