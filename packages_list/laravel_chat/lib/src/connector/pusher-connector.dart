import 'package:laravel_chat/src/connector/connector.dart';
import 'package:laravel_chat/src/channel/pusher-channel.dart';
import 'package:laravel_chat/src/channel/pusher-private-channel.dart';
import 'package:laravel_chat/src/channel/pusher-presence-channel.dart';
import 'package:laravel_chat/src/channel/pusher-encrypted-private-channel.dart';
...
class PusherConnector extends Connector {
  ...
  PusherEncryptedPrivateChannel encryptedPrivateChannel(String name) {
    ...
    return this.channels['private-encrypted-$name'] as PusherEncryptedPrivateChannel;
  }
