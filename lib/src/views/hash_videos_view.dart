  ...
  Widget build(BuildContext context) {
    return Stack(
      children: [
        WillPopScope(
          onWillPop: () async {
            videoRepo.currentHashTag.value = BannerModel.fromJSON({});
            videoRepo.currentHashTag.notifyListeners();
          ...
          child: ValueListenableBuilder(
              valueListenable: videoRepo.currentHashTag,
              builder: (context, BannerModel hashTagObject, _) {
                String hashTagString = hashTagObject.tag;
                                        ...
                                        child: SingleChildScrollView(
                                          child: Column(
                                            ...
                                            children: <Widget>[
                                              ...
                                              (hashTagString == "" && data.banners.isNotEmpty)
                                                  ? Padding(
                                                        ...
                                                        items: data.banners.map((var value) {
                                                          return Builder(
                                                            builder: (BuildContext context) {
                                                              return InkWell(
                                                                onTap: () {
                                                                  videoRepo.currentHashTag.value = value;
                                              ...
                                              Padding(
                                                ...
                                                child: Align(
                                                  ...
                                                  child: Container(
                                                    child: Text(
                                                      hashTagString != "" ? "Top Videos" : 'Recommended',
                                                      style: TextStyle(
                                                        color: settingRepo.setting.value.textColor,
                                                        fontSize: 19,
                                                        fontWeight: FontWeight.w500,
                                              ...
                                              (data.videos.isNotEmpty)
                                                  ? Padding(
                                                      ...
                                                      child: Container(
                                                        width: MediaQuery.of(context).size.width,
                                                        height: MediaQuery.of(context).size.height - (hashTagString == "" && data.banners.isNotEmpty ? 310 : 130),
                                                        child: GridView.builder(
                                                          ...
                                                          itemBuilder: (BuildContext context, int i) {
                                                            return GestureDetector(
                                                              onTap: () async {
                                                                print("videoRepo.currentHashTag.value.id");
                                                                print(videoRepo.currentHashTag.value.id.toString() + videoRepo.userVideoObj.value.hashTag + videoRepo.currentHashTag.value.tag);
                                                                if (videoRepo.currentHashTag.value.id > 0) {
                                                                  videoRepo.userVideoObj.value.hashTag = videoRepo.currentHashTag.value.tag;
                                                                  videoRepo.userVideoObj.value.name = "#${videoRepo.currentHashTag.value.tag}";
                                                                } else {
                                                                  videoRepo.userVideoObj.value.userId = data.videos[i].userId;
                                                                  videoRepo.userVideoObj.value.name = data.videos[i].userName + "'s";
                                                                }
                                                                videoRepo.userVideoObj.value.videoId = data.videos[i].id;
                                                                videoRepo.currentHashTag.value = BannerModel.fromJSON({});
                                                                videoRepo.currentHashTag.notifyListeners();
                                                            ...
                                                            return Container(
                                                              ...
                                                              child: GestureDetector(
                                                                onTap: () async {
                                                                  print("videoRepo.currentHashTag.value.id");
                                                                  print(videoRepo.currentHashTag.value.id.toString() + videoRepo.userVideoObj.value.hashTag + videoRepo.currentHashTag.value.tag);
                                                                  print(videoRepo.currentHashTag.value.tag);
                                                                  if (videoRepo.currentHashTag.value.id > 0) {
                                                                    videoRepo.userVideoObj.value.hashTag = videoRepo.currentHashTag.value.tag;
                                                                    videoRepo.userVideoObj.value.name = "#${videoRepo.currentHashTag.value.tag}";
                                                                  } else {
