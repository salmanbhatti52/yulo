                                    ...
                                    children: [
                                      GestureDetector(
                                        ...
                                        child: Container(
                                          ...
                                          child: Center(child: "${obj.users[i].followText}".text.wide.color((obj.users[i].followText == 'Unfollow') ? settingRepo.setting.value.inactiveButtonTextColor! : settingRepo.setting.value.buttonTextColor!).size(14).make()),
                                        ),
                                      ),
                                      SizedBox(
              ...
              builder: (context, bool showLoading, _) {
                return ModalProgressHUD(
                  ...
                  child: Scaffold(
                    ...
                    body: SafeArea(maintainBottomViewPadding: true, child: SingleChildScrollView(child: tabs(_user))),
                  ),
                );
              });
        });
