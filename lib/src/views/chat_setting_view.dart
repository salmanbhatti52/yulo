          ...
          actions: [
            InkWell(
              ...
              child: Container(
                ...
                child: "Update".text.size(10).uppercase.center.color(settingRepo.setting.value.buttonTextColor!).make().centered().pSymmetric(h: 8, v: 0),
              ).pSymmetric(h: 15, v: 8),
            )
          ],
          centerTitle: true,
                                            ...
                                            Expanded(
                                              ...
                                              child: Transform.scale(
                                                ...
                                                child: CupertinoSwitch(
                                                  activeColor: settingRepo.setting.value.buttonColor,
