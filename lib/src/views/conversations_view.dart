                                                            ...
                                                            return InkWell(
                                                              ...
                                                              child: Column(
                                                                children: [
                                                                  ...
                                                                  Container(
                                                                    width: 50,
                                                                    child: "${onlineUserItem.name}".text.bold.size(12).color(settingRepo.setting.value.textColor!.withOpacity(0.5)).ellipsis.make().centered(),
                                                                  )
                                                                ],
                                                              ).pOnly(right: 15),
                                                            );
                                        ...
                                        children: [
                                          InkWell(
                                            ...
                                            child: Container(
                                              ...
                                              child: "Chat".text.uppercase.bold.size(16).color(active == 1 ? settingRepo.setting.value.accentColor! : settingRepo.setting.value.textColor!).make().pSymmetric(h: 15, v: 15),
                                            ),
                                          ),
                                          SizedBox(
                                            width: 20,
                                          ...
                                          InkWell(
                                            ...
                                            child: Container(
                                              ...
                                              child: "People".text.uppercase.bold.size(16).color(active == 2 ? settingRepo.setting.value.accentColor! : settingRepo.setting.value.textColor!).make().pSymmetric(h: 15, v: 15),
                                            ),
                                          ),
                                        ],
                                      ),
                                              ...
                                              return Container(
                                                ...
                                                child: _people.users.length > 0
                                                    ...
                                                    : !loader
                                                        ? Container(
                                                            height: config.App(context).appHeight(40),
                                                            child: active == 1 ? "No conversation yet.".text.size(17).color(settingRepo.setting.value.textColor!.withOpacity(0.5)).make() : "No people yet.".text.size(17).color(settingRepo.setting.value.textColor!.withOpacity(0.5)).make(),
                                                          )
                                                        : SizedBox(
                                                            height: 0,
                                                          ),
