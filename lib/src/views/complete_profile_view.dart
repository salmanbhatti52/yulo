                              ...
                              Navigator.of(context).push(MaterialPageRoute(builder: (context) {
                                return Scaffold(
                                    ...
                                    body: Center(
                                      child: PhotoView(
                                        enableRotation: true,
                                        imageProvider: userRepo.socialUserProfile.value.userDP != '' ? CachedNetworkImageProvider(userRepo.socialUserProfile.value.userDP) : AssetImage("assets/images/splash.png") as ImageProvider,
                                      ),
                                    ));
                              }));
                              _con.pc.close();
