                                      ...
                                      children: <Widget>[
                                        ...
                                        InkWell(
                                          ...
                                          child: Container(
                                            ...
                                            child: "Continue".text.size(20).center.color(settingRepo.setting.value.buttonTextColor!).make().centered().pSymmetric(h: 10, v: 0),
                                          ).pSymmetric(h: 20),
                                        ),
                                        SizedBox(
                                          height: config.App(context).appHeight(3),
                                        ),
                                        ((!Platform.isAndroid && data.appleLogin != null && data.appleLogin == true) || (data.googleLogin != null && data.googleLogin == true) || (data.fbLogin != null && data.fbLogin == true))
                                            ? Container(
                                                child: Row(
                                        ...
                                        SizedBox(
                                          height: ((!Platform.isAndroid && data.appleLogin != null && data.appleLogin == true) || (data.googleLogin != null && data.googleLogin == true) || (data.fbLogin != null && data.fbLogin == true)) ? config.App(context).appHeight(3) : 0,
                                        ),
                                        Container(
                                          child: Row(
                                        ...
                                        data.privacyPolicy != null
                                            ? data.privacyPolicy.text.center.color(settingRepo.setting.value.textColor!.withOpacity(0.7)).size(16).wide.lineHeight(1.4).make().centered().pSymmetric(h: 20)
                                        ...
                                        InkWell(
                                          ...
                                          child: Container(
                                            ...
                                            //   color: settingRepo.setting.value.buttonColor,
                                            // ),
                                            child: "Already have an account. Sign in".text.size(16).underline.center.color(settingRepo.setting.value.textColor!).make().centered().pSymmetric(h: 10, v: 0),
                                          ),
                                        ),
                                      ],
                                    ),
