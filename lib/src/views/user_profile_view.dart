                                    ...
                                    Container(
                                      child: GridView.builder(
                                          ...
                                          itemBuilder: (BuildContext context, int index) {
                                            ...
                                            return InkWell(
                                              onTap: () {
                                                videoRepo.userVideoObj.value.userId = item.userId;
                                                videoRepo.userVideoObj.value.videoId = item.videoId;
                                                videoRepo.userVideoObj.value.name = _userProfile.name.split(" ").first + "'s";
                                                videoRepo.homeCon.value.showFollowingPage.value = false;
                                                videoRepo.homeCon.value.showFollowingPage.notifyListeners();
