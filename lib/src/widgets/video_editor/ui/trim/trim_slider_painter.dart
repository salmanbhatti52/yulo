...
class TrimSliderPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    if (style.leftIcon != null) {
      ...
      leftArrow.text = TextSpan(text: String.fromCharCode(style.leftIcon!.codePoint), style: TextStyle(fontSize: style.iconSize, fontFamily: style.leftIcon!.fontFamily, color: style.iconColor));
      leftArrow.layout();
      leftArrow.paint(canvas, Offset(rect.left - style.iconSize / 2, halfHeight - style.iconSize / 2));
    }
    ...
    if (style.rightIcon != null) {
      ...
      rightArrow.text = TextSpan(text: String.fromCharCode(style.rightIcon!.codePoint), style: TextStyle(fontSize: style.iconSize, fontFamily: style.rightIcon!.fontFamily, color: style.iconColor));
      rightArrow.layout();
      rightArrow.paint(canvas, Offset(rect.right - style.iconSize / 2, halfHeight - style.iconSize / 2));
    }
  }
